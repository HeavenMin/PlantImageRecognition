...
- (void)runCNNOnFrame:(CVPixelBufferRef)pixelBuffer {
    ...
    if (tf_session.get() and isRunning == true) {
...
- (void)viewDidLoad {
    ...
    // flower labels library
    tableData = [NSArray arrayWithObjects:@"Alstromeria",@"Amaryllis",@"Anemone",@"Anthurium",@"Apple blossom",@"Aster",@"Bird Of Paradise",@"Bourvardia",@"Camellia",@"Carnations",@"Cherry Blossom",@"Chrysanthemums",@"Crocus",@"Cypress",@"Daffodils",@"Dahlia",@"Daisies",@"Delphinium",@"Freesia",@"Gerberas",@"Gladioli",@"Heather",@"Hibiscus",@"Hydrangea",@"Iris",@"Jasmine",@"Laurel",@"Lavender",@"Lilac",@"Lilies",@"Lisianthus",@"Lotus",@"Magnolia",@"Marigold",@"Morning Glory",@"Orchids",@"Pansy",@"Peony",@"Poinsettia",@"Proteas",@"Queen Anne’s Lace",@"Ranunculus",@"Rose",@"Snapdragons",@"Statice",@"Stock",@"Sunflower",@"Sweet pea",@"Tulips",@"Violet", nil];
...
- (void)addLabelLayerWithText:(NSString *)text
    ...
    //Menlo-Regular
    CFTypeRef font = (CFTypeRef) @"Optima-ExtraBlack";
...
//    cell.textLabel.font = [cell.textLabel.font fontWithSize:19];
    cell.textLabel.font = [UIFont fontWithName:@"Optima-ExtraBlack" size:19];
